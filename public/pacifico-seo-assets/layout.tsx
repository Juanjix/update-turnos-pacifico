...
const SITE_URL  = process.env.NEXT_PUBLIC_SITE_URL ?? 'https://pacifico-tenis.vercel.app'
...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title:       'Club Pacífico Tenis — Reservas Online',
    description: 'Reservá tu cancha de tenis online · Club Pacífico · Bahía Blanca',
    images:      ['/og-image.png'],
  },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              sport: 'Tennis',
              amenityFeature: [
                { '@type': 'LocationFeatureSpecification', name: 'Canchas descubiertas', value: 4 },
                { '@type': 'LocationFeatureSpecification', name: 'Canchas cubiertas',    value: 2 },
